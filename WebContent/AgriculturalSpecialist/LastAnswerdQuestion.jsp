<!DOCTYPE html>
<%@page import="questionAndAnswer.QuestionAndAnswer"%>
...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        %>
        <form action = "../ShowLastAnsweredQuestionDetails" method = "post">
        <input type="text" name = "nic" value =<% out.print("\"" + nic + "\""); %> hidden >
        <input type = "submit">
        </form>
